...
Guide for cross-checking the AI developmental review of *The Woman in My Phone* (V9, 64K words, literary fiction).
...
- **Reedsy** — https://reedsy.com/hire/us/developmental-editors/ (filter by literary fiction; profiles show past projects)
- **Editorial Freelancers Association (EFA)** — https://www.the-efa.org/ (searchable directory, vetted members)
- **NY Book Editors** — https://nybookeditors.com/ (former Big Five editors, pricier but experienced)
- **The Editorial Department** — https://editorialdepartment.com/

**South Asian / diaspora-focused:**
...
2. One-paragraph synopsis (arc + ending) — see `SYNOPSIS.md`
3. Comp titles (e.g., "Interpreter of Maladies meets Normal People")
4. Specific concerns: "Timeline consistency, whether the Priya subplot lands, pacing in Part 3"
5. Target audience: literary fiction, South Asian diaspora readers, 25–45
6. Your timeline and budget

---

## Evaluation Criteria to Request

Ask them to assess:

| Area | What to ask |
|------|-------------|
| Structure | Does the 6-part architecture earn its weight? Any sagging sections? |
| Character arcs | Do Ari, Meera, and Priya each change believably? |
| Dialogue | Voice consistency — does each character sound distinct? |
| Theme | Does the diaspora/identity thread feel integrated or bolted on? |
| Continuity | Timeline, ages, factual consistency across chapters |
| Pacing | Where did you skim? Where did you want more? |
| Emotional stakes | Which scenes land, which feel unearned? |
| Opening/ending | Hook strength, resolution satisfaction |

---

## Deliverable to Request

- **10–15 page editorial letter** (high-level assessment, what's working, what isn't, prioritized recommendations)
- **Inline comments** in the manuscript (scene-level notes, line-level suggestions)

This is the standard developmental edit deliverable. Some editors also offer a follow-up call — worth it for clarifying intent vs. execution questions.

---

## Notes for the Editor

- An AI developmental review has already been done (see `REVIEW-V9-POST-EDIT.md`). You can share this with the editor or not — up to you. Sharing it gives them a starting point but may anchor their read.
- Timeline has been verified and fixed. Key dates: Ari born Dec 27, 1986. First crossing Feb–Mar 2019. Baby born July 2019. Story present is 2026.
- The manuscript uses first-person present tense throughout except for two starred (★) chapters in close third.
